...
export const metadata: Metadata = {
  title: "73 Ways People Use HeyStax",
  description:
    "From consultants juggling clients to parents managing school chaos — discover how real people use HeyStax to eliminate the reconstruction tax.",
  keywords: [
...
const collectionJsonLd = {
  ...
  "@type": "CollectionPage",
  name: "73 Ways People Use HeyStax",
  description:
    "From consultants juggling clients to parents managing school chaos — discover how real people use HeyStax to eliminate the reconstruction tax.",
  url: "https://heystax.ai/use-cases",
};
