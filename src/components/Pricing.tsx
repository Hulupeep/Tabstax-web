    ...
    <section id="pricing" className="bg-cream py-20 md:py-28">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Free */}
          <div className="bg-cream-dark border border-charcoal/10 rounded-2xl p-8 shadow-sm">
          ...
          {/* Pro */}
          <div className="bg-cream-dark border-2 border-amber rounded-2xl p-8 shadow-md relative">
            ...
            <p className="mt-1 text-warm-gray text-sm">For power users and teams</p>
            <p className="mt-6 font-heading font-bold text-4xl text-charcoal">
              &euro;3.99
